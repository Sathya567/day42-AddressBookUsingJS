class Contact {
    ...
    set firstName(firstName) { 
        const nameRegexPattern = RegExp("^[A-Z][a-z]{2,}$");
    ...
    set phoneNo(phoneNo) {
        const phoneRegex = RegExp("^[0-9]{2}[ ][6-9][0-9]{9}$");
    ...
    set email(email) {
        const emailRegex = RegExp("^[A-Z0-9a-z]+([+-.#$^*][0-9]+)?[0-9]*[@][A-Za-z0-9]+[.][A-Za-z]{2,}([.][a-zA-Z]{2,})?$");
...
let contact1 = new Contact("Sathya", "Sriman", "Ymk nagar", "Adoni", "AndhraPradesh", "518301", "91 7989501656", "satyabhandari43@gmail.com");
 let contact2 = new Contact("Sunanda", "Kodandi", "Kana Chowk", "Solapur", "Maharastra", "512582", "91 9866566594", "Sunanda43@gmail.com");
 try{
...
//editContact("Sunanda", "Kodandi", "address", "Pune");
//console.log(addressBookArr);

//deleteContact("Sunanda", "Kodandi");
console.log(addressBookArr);
